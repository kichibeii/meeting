...
<head lang="en">
  ...
  <link rel='shortcut icon' type='image/x-icon' href='<?=base_url()?>/assets/img/jiepicon.jpg' />
  <title>Meeting &lsaquo; Informasi Meeting</title>

  <link href="<?=base_url()?>assets/metroui/css/metro.css" rel="stylesheet">
  <link href="<?=base_url()?>assets/metroui/css/custom.css" rel="stylesheet">
  <link href="<?=base_url()?>assets/metroui/css/metro-icons.css" rel="stylesheet">
  <link href="<?=base_url()?>assets/metroui/css/segmdl2-icons.css" rel="stylesheet">
  <link href="<?=base_url()?>assets/metroui/css/metro-responsive.css" rel="stylesheet">
  <link href="<?=base_url()?>assets/metroui/css/metro-schemes.css" rel="stylesheet">

  <link href="<?=base_url()?>assets/metroui/css/docs.css" rel="stylesheet">
  <link href="<?=base_url()?>assets/css/li-scroller.css" rel="stylesheet">

  <script src="<?=base_url()?>assets/metroui/js/jquery-2.1.3.min.js"></script>
  <script src="<?=base_url()?>assets/metroui/js/metro.js"></script>
  <script src="<?=base_url()?>assets/metroui/js/docs.js"></script>
  <script src="<?=base_url()?>assets/metroui/js/prettify/run_prettify.js"></script>
  <script src="<?=base_url()?>assets/metroui/js/jquery.dataTables2.min.js"></script>
  <script src="<?=base_url()?>assets/metroui/js/jquery.priceformat.min.js"></script>
