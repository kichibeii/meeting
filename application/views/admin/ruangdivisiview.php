  ...
  <div class="container body" style="top: 0; bottom: 0; left: 0; height: 100%">
    ...
    <div class="">
      <div class="col-md-12 col-sm-12 col-xs-12">
        ...
        <li role="presentation" class=""><a href="#tab_content3" role="tab" id="snack-tab" data-toggle="tab" aria-expanded="false">Snack</a>
        </li>
      </ul>
      <!-- /tab header -->
                    ...
                    <div class="modal-dialog modal-md">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          ...
                          <br>
                          <input class="form-control" placeholder="show room" type="number" name="showroom"  min="0" max="1" id="sm" style="color: black" required>
                        </div>
      ...
      <div role="tabpanel" class="tab-pane fade" id="tab_content2" aria-labelledby="meeting-tab">
        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
          <div class="x_panel">
           ...
           <!--content 3-->
           <div role="tabpanel" class="tab-pane fade" id="tab_content3" aria-labelledby="snack-tab">
            ...
            <table id="datatable" class="table table-striped table-bordered dt-responsive nowrap table-bordered jambo_table bulk_action" cellspacing="0" width="100%">
              <thead>
                <tr class="headings">
                  ...
                  <th style="text-align:center">Estimated Participants</th>
                  <th style="text-align:center">Division</th>
              ...
              <tbody>
                <?php 
                foreach($snacks as $snack_item):
                  $now = date("Y-m-d");
                $date = date('Y-m-d');
                $tomorrow = date('Y-m-d', strtotime($date .' +1 day'));
                if ($now == $snack_item['tanggal']){?>
                <tr style="background-color: lightblue">
                  <?php
                }else if($snack_item['tanggal']==$tomorrow){?>
                ...
                ?>
                <td style="text-align:center"><?=date("d-M-Y",strtotime($snack_item['tanggal']))?></td>
                <td style="text-align:center"><?=$snack_item['estimasi_peserta']?></td>
                <td style="text-align:center"><?=$snack_item['nama_divisi']?></td>
                <td style="text-align:center"><?=$snack_item['note']?></td>
              </tr>
            <?php endforeach?>
          </tbody>
        </table>
